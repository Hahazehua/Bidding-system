...
<body>
  ...
  <div id="content">
	...
	$sql = "SELECT id,pname, price, image_url,description, seller, category, seller_time, features,bids FROM product4"; 
        ...
        echo '<div class="card">
                ...
                <div class="card__body">
                 ...
                 <div class="card__footer">
                      ...
                      <div class="action">
                        <a href="product_detail.php?page=product4&id=' . $row["id"] . '"><button type="button">Go for bid</button></a>
                      </div>
                    </div>
                  </div>';
        echo '<script>
